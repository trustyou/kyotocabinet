        ...
        public:
            ...
            bool open ( const std::string &path = ":", uint32_t mode = OWRITER | OCREATE )
            {
                ...
                if ( type_ == TYPEMISC )
                {
                    if ( logger_ )
                    {
                        db_->tune_logger ( logger_, logkinds_ );
                    }
                    if ( mtrigger_ )
                    {
                                ...
                                else
                                {
                                    ...
                                    if ( pv )
                                    {
                                        ...
                                        if ( !std::strcmp ( pv, "kcph" ) || !std::strcmp ( pv, "phdb" ) )
                                        {
                                            ...
                                            if ( !std::strcmp ( pv, "kcpt" ) || !std::strcmp ( pv, "ptdb" ) )
                                            {
                                                type = TYPEPTREE;
                                            }
                                            else
                                                if ( !std::strcmp ( pv, "kcs" ) || !std::strcmp ( pv, "sdb" ) )
                                                {
                                                    type = TYPESTASH;
                                                }
                                                else
                                                    if ( !std::strcmp ( pv, "kcc" ) || !std::strcmp ( pv, "cdb" ) )
                                                    {
                                                        type = TYPECACHE;
                                                    }
                                                    else
                                                        if ( !std::strcmp ( pv, "kcg" ) || !std::strcmp ( pv, "gdb" ) )
                                                        {
                                                            type = TYPEGRASS;
                                                        }
                                                        else
                                                            if ( !std::strcmp ( pv, "kch" ) || !std::strcmp ( pv, "hdb" ) )
                                                            {
                                                                ...
                                                                if ( !std::strcmp ( pv, "kct" ) || !std::strcmp ( pv, "tdb" ) )
                                                                {
                                                                    type = TYPETREE;
                                                                }
                                                                else
                                                                    if ( !std::strcmp ( pv, "kcd" ) || !std::strcmp ( pv, "ddb" ) )
                                                                    {
                                                                        type = TYPEDIR;
                                                                    }
                                                                    else
                                                                        if ( !std::strcmp ( pv, "kcf" ) || !std::strcmp ( pv, "fdb" ) )
                                                                        {
                                                                            type = TYPEFOREST;
                                                                        }
                                                                        else
                                                                            if ( !std::strcmp ( pv, "kcx" ) || !std::strcmp ( pv, "xdb" ) ||
                    ...
                    if ( strsplit ( *it, '=', &fields ) > 1 )
                    {
                        ...
                        if ( !std::strcmp ( key, "type" ) )
                        {
                                    ...
                                    !std::strcmp ( value, "phdb" ) || !std::strcmp ( value, "phash" ) )
                            {
                                ...
                                if ( !std::strcmp ( value, "+" ) || !std::strcmp ( value, "kcpt" ) ||
                                        !std::strcmp ( value, "ptdb" ) || !std::strcmp ( value, "ptree" ) )
                                {
                                    type = TYPEPTREE;
                                }
                                else
                                    if ( !std::strcmp ( value, ":" ) || !std::strcmp ( value, "kcs" ) ||
                                            !std::strcmp ( value, "sdb" ) || !std::strcmp ( value, "stash" ) )
                                    {
                                        type = TYPESTASH;
                                    }
                                    else
                                        if ( !std::strcmp ( value, "*" ) || !std::strcmp ( value, "kcc" ) ||
                                                !std::strcmp ( value, "cdb" ) || !std::strcmp ( value, "cache" ) )
                                        {
                                            type = TYPECACHE;
                                        }
                                        else
                                            if ( !std::strcmp ( value, "%" ) || !std::strcmp ( value, "kcg" ) ||
                                                    !std::strcmp ( value, "gdb" ) || !std::strcmp ( value, "grass" ) )
                                            {
                                                type = TYPEGRASS;
                                            }
                                            else
                                                if ( !std::strcmp ( value, "kch" ) || !std::strcmp ( value, "hdb" ) ||
                                                        !std::strcmp ( value, "hash" ) )
                                                {
                                                    type = TYPEHASH;
                                                }
                                                else
                                                    if ( !std::strcmp ( value, "kct" ) || !std::strcmp ( value, "tdb" ) ||
                                                            !std::strcmp ( value, "tree" ) )
                                                    {
                                                        type = TYPETREE;
                                                    }
                                                    else
                                                        if ( !std::strcmp ( value, "kcd" ) || !std::strcmp ( value, "ddb" ) ||
                                                                !std::strcmp ( value, "dir" ) || !std::strcmp ( value, "directory" ) )
                                                        {
                                                            type = TYPEDIR;
                                                        }
                                                        else
                                                            if ( !std::strcmp ( value, "kcf" ) || !std::strcmp ( value, "fdb" ) ||
                                                                    !std::strcmp ( value, "for" ) || !std::strcmp ( value, "forest" ) )
                                                            {
                                                                type = TYPEFOREST;
                                                            }
                                                            else
                                                                if ( !std::strcmp ( value, "kcx" ) || !std::strcmp ( value, "xdb" ) ||
                            ...
                            if ( !std::strcmp ( key, "log" ) || !std::strcmp ( key, "logger" ) )
                            {
                                logname = value;
                            }
                            else
                                if ( !std::strcmp ( key, "logkinds" ) || !std::strcmp ( key, "logkind" ) )
                                {
                                    if ( !std::strcmp ( value, "debug" ) || !std::strcmp ( value, "debugging" ) )
                                    {
                                        ...
                                        if ( !std::strcmp ( value, "info" ) || !std::strcmp ( value, "information" ) )
                                        {
                                            logkinds = Logger::INFO | Logger::WARN | Logger::ERROR;
                                        }
                                        else
                                            if ( !std::strcmp ( value, "warn" ) || !std::strcmp ( value, "warning" ) )
                                            {
                                                logkinds = Logger::WARN | Logger::ERROR;
                                            }
                                            else
                                                if ( !std::strcmp ( value, "error" ) || !std::strcmp ( value, "fatal" ) )
                                                {
                                    ...
                                    if ( !std::strcmp ( key, "logpx" ) || !std::strcmp ( key, "lpx" ) )
                                    {
                                        logpx = value;
                                    }
                                    else
                                        if ( !std::strcmp ( key, "mtrg" ) || !std::strcmp ( key, "metatrigger" ) ||
                                                !std::strcmp ( key, "meta_trigger" ) )
                                        {
                                            mtrgname = value;
                                        }
                                        else
                                            if ( !std::strcmp ( key, "mtrgpx" ) || !std::strcmp ( key, "mtpx" ) )
                                            {
                                                mtrgpx = value;
                                            }
                                            else
                                                if ( !std::strcmp ( key, "bnum" ) || !std::strcmp ( key, "buckets" ) )
                                                {
                                                    bnum = atoix ( value );
                                                }
                                                else
                                                    if ( !std::strcmp ( key, "capcnt" ) || !std::strcmp ( key, "capcount" ) ||
                                                            !std::strcmp ( key, "cap_count" ) )
                                                    {
                                                        capcnt = atoix ( value );
                                                    }
                                                    else
                                                        if ( !std::strcmp ( key, "capsiz" ) || !std::strcmp ( key, "capsize" ) ||
                                                                !std::strcmp ( key, "cap_size" ) )
                                                        {
                                                            capsiz = atoix ( value );
                                                        }
                                                        else
                                                            if ( !std::strcmp ( key, "apow" ) || !std::strcmp ( key, "alignment" ) )
                                                            {
                                                                apow = atoix ( value );
                                                            }
                                                            else
                                                                if ( !std::strcmp ( key, "fpow" ) || !std::strcmp ( key, "fbp" ) )
                                                                {
                                                                    fpow = atoix ( value );
                                                                }
                                                                else
                                                                    if ( !std::strcmp ( key, "opts" ) || !std::strcmp ( key, "options" ) )
                                                                    {
                                                                        if ( std::strchr ( value, 's' ) )
                                                                        {
                                                                            tsmall = true;
                                                                        }
                                                                        if ( std::strchr ( value, 'l' ) )
                                                                        {
                                                                            tlinear = true;
                                                                        }
                                                                        if ( std::strchr ( value, 'c' ) )
                                                                        {
                                                                            tcompress = true;
                                                                        }
                                                                    }
                                                                    else
                                                                        if ( !std::strcmp ( key, "msiz" ) || !std::strcmp ( key, "map" ) )
                                                                        {
                                                                            msiz = atoix ( value );
                                                                        }
                                                                        else
                                                                            if ( !std::strcmp ( key, "dfunit" ) || !std::strcmp ( key, "defrag" ) )
                                                                            {
                                                                                dfunit = atoix ( value );
                                                                            }
                                                                            else
                                                                                if ( !std::strcmp ( key, "zcomp" ) || !std::strcmp ( key, "compressor" ) )
                                                                                {
                                                                                    zcompname = value;
                                                                                }
                                                                                else
                                                                                    if ( !std::strcmp ( key, "psiz" ) || !std::strcmp ( key, "page" ) )
                                                                                    {
                                                                                        psiz = atoix ( value );
                                                                                    }
                                                                                    else
                                                                                        if ( !std::strcmp ( key, "pccap" ) || !std::strcmp ( key, "cache" ) )
                                                                                        {
                                                                                            pccap = atoix ( value );
                                                                                        }
                                                                                        else
                                                                                            if ( !std::strcmp ( key, "rcomp" ) || !std::strcmp ( key, "comparator" ) )
                                                                                            {
                                                                                                if ( !std::strcmp ( value, "lex" ) || !std::strcmp ( value, "lexical" ) )
                                                                                                {
                                                                                                    ...
                                                                                                    if ( !std::strcmp ( value, "dec" ) || !std::strcmp ( value, "decimal" ) )
                                                                                                    {
                                                                                                        rcomp = DECIMALCOMP;
                                                                                                    }
                                                                                                    else
                                                                                                        if ( !std::strcmp ( value, "lexdesc" ) || !std::strcmp ( value, "lexicaldesc" ) )
                                                                                                        {
                                                                                                            rcomp = LEXICALDESCCOMP;
                                                                                                        }
                                                                                                        else
                                                                                                            if ( !std::strcmp ( value, "decdesc" ) || !std::strcmp ( value, "decimaldesc" ) )
                                                                                                            {
                                                                                                                rcomp = DECIMALDESCCOMP;
                                                                                                            }
                                                                                            }
                                                                                            else
                                                                                                if ( !std::strcmp ( key, "zkey" ) || !std::strcmp ( key, "pass" ) ||
                ...
                if ( !logname.empty() )
                {
                    ...
                    if ( logname == "-" || logname == "[stdout]" || logname == "[cout]" )
                    {
                        ...
                        if ( logname == "+" || logname == "[stderr]" || logname == "[cerr]" )
                        {
                            stdlogstrm = &std::cerr;
                        }
                        else
                        {
                            ...
                            if ( !*ofs )
                            {
                                ofs->open ( logname.c_str(), std::ios_base::out | std::ios_base::binary );
                            }
                            if ( ofs )
                            {
                                stdlogstrm = ofs;
                    ...
                    if ( stdlogstrm )
                    {
                        stdlogger_ = new StreamLogger ( stdlogstrm, logpx.c_str() );
                    }
                }
                delete stdmtrigger_;
                delete stdmtrgstrm_;
                ...
                if ( !mtrgname.empty() )
                {
                    ...
                    if ( mtrgname == "-" || mtrgname == "[stdout]" || mtrgname == "[cout]" )
                    {
                        ...
                        if ( mtrgname == "+" || mtrgname == "[stderr]" || mtrgname == "[cerr]" )
                        {
                        ...
                        else
                        {
                            ...
                            if ( !*ofs )
                            {
                                ofs->open ( mtrgname.c_str(), std::ios_base::out | std::ios_base::binary );
                            }
                            if ( ofs )
                            {
                                stdmtrgstrm = ofs;
                    ...
                    if ( stdmtrgstrm )
                    {
                        stdmtrigger_ = new StreamMetaTrigger ( stdmtrgstrm, mtrgpx.c_str() );
                    }
                }
                delete zcomp_;
                zcomp_ = NULL;
                ...
                if ( !zcompname.empty() )
                {
                    if ( zcompname == "zlib" || zcompname == "raw" )
                    {
                        ...
                        if ( zcompname == "def" || zcompname == "deflate" )
                        {
                            zcomp_ = new ZLIBCompressor<ZLIB::DEFLATE>;
                        }
                        else
                            if ( zcompname == "gz" || zcompname == "gzip" )
                            {
                                zcomp_ = new ZLIBCompressor<ZLIB::GZIP>;
                            }
                            else
                                if ( zcompname == "lzo" || zcompname == "oz" )
                                {
                                    zcomp_ = new LZOCompressor<LZO::RAW>;
                                }
                                else
                                    if ( zcompname == "lzocrc" || zcompname == "ozcrc" )
                                    {
                                        zcomp_ = new LZOCompressor<LZO::CRC>;
                                    }
                                    else
                                        if ( zcompname == "lzma" || zcompname == "xz" )
                                        {
                                            zcomp_ = new LZMACompressor<LZMA::RAW>;
                                        }
                                        else
                                            if ( zcompname == "lzmacrc" || zcompname == "xzcrc" )
                                            {
                                                zcomp_ = new LZMACompressor<LZMA::CRC>;
                                            }
                                            else
                                                if ( zcompname == "lzmasha" || zcompname == "xzsha" )
                                                {
                                                    zcomp_ = new LZMACompressor<LZMA::SHA>;
                                                }
                                                else
                                                    if ( zcompname == "arc" || zcompname == "rc4" )
                                                    {
                                                        arccomp = new ArcfourCompressor();
                                                        zcomp_ = arccomp;
                                                    }
                                                    else
                                                        if ( zcompname == "arcz" || zcompname == "rc4z" )
                                                        {
                                                            arccomp = new ArcfourCompressor();
                    ...
                    case TYPECACHE:
                        {
                            ...
                            if ( opts > 0 )
                            {
                                cdb->tune_options ( opts );
                            }
                            if ( bnum > 0 )
                            {
                                cdb->tune_buckets ( bnum );
                            }
                            if ( zcomp_ )
                            {
                                cdb->tune_compressor ( zcomp_ );
                            }
                            if ( capcnt > 0 )
                            {
                                cdb->cap_count ( capcnt );
                            }
                            if ( capsiz > 0 )
                            {
                                cdb->cap_size ( capsiz );
                    ...
                    case TYPEGRASS:
                        {
                            ...
                            if ( opts > 0 )
                            {
                                gdb->tune_options ( opts );
                            }
                            if ( bnum > 0 )
                            {
                                gdb->tune_buckets ( bnum );
                            }
                            if ( psiz > 0 )
                            {
                                gdb->tune_page ( psiz );
                            ...
                            if ( zcomp_ )
                            {
                                gdb->tune_compressor ( zcomp_ );
                            }
                            if ( pccap > 0 )
                            {
                                gdb->tune_page_cache ( pccap );
                            }
                            if ( rcomp )
                            {
                                gdb->tune_comparator ( rcomp );
                            }
                            db = gdb;
                            break;
                        }
                    case TYPEHASH:
                        {
                            ...
                            if ( opts > 0 )
                            {
                                hdb->tune_options ( opts );
                            }
                            if ( bnum > 0 )
                            {
                                hdb->tune_buckets ( bnum );
                            }
                            if ( msiz >= 0 )
                            {
                                hdb->tune_map ( msiz );
                            ...
                            if ( dfunit > 0 )
                            {
                                hdb->tune_defrag ( dfunit );
                            }
                            if ( zcomp_ )
                            {
                                hdb->tune_compressor ( zcomp_ );
                            }
                            db = hdb;
                            break;
                        }
                    case TYPETREE:
                        {
                            ...
                            if ( opts > 0 )
                            {
                                tdb->tune_options ( opts );
                            }
                            if ( bnum > 0 )
                            {
                                tdb->tune_buckets ( bnum );
                            }
                            if ( psiz > 0 )
                            {
                                tdb->tune_page ( psiz );
                            ...
                            if ( dfunit > 0 )
                            {
                                tdb->tune_defrag ( dfunit );
                            }
                            if ( zcomp_ )
                            {
                                tdb->tune_compressor ( zcomp_ );
                            }
                            if ( pccap > 0 )
                            {
                                tdb->tune_page_cache ( pccap );
                            }
                            if ( rcomp )
                            {
                                tdb->tune_comparator ( rcomp );
                            }
                            db = tdb;
                            break;
                        }
                    case TYPEDIR:
                        {
                            ...
                            if ( opts > 0 )
                            {
                                ddb->tune_options ( opts );
                            }
                            if ( zcomp_ )
                            {
                                ddb->tune_compressor ( zcomp_ );
                            }
                            db = ddb;
                            break;
                        }
                    case TYPEFOREST:
                        {
                            ...
                            if ( opts > 0 )
                            {
                                fdb->tune_options ( opts );
                            }
                            if ( bnum > 0 )
                            {
                                fdb->tune_buckets ( bnum );
                            }
                            if ( psiz > 0 )
                            {
                                fdb->tune_page ( psiz );
                            ...
                            if ( zcomp_ )
                            {
                                fdb->tune_compressor ( zcomp_ );
                            }
                            if ( pccap > 0 )
                            {
                                fdb->tune_page_cache ( pccap );
                            }
                            if ( rcomp )
                            {
                                fdb->tune_comparator ( rcomp );
                            }
                            db = fdb;
                            break;
                        }
                ...
                if ( arccomp )
                {
                    arccomp->set_key ( zkey.c_str(), zkey.size() );
                }
                         ...
                         ProgressChecker *checker = NULL )
            {
                ...
                while ( !err && !lines.empty() )
                {
                    ...
                    switch ( mode )
                    {
                        case MSET:
                            {
                                if ( !set ( line.kbuf, line.ksiz, line.vbuf, line.vsiz ) )
                                {
                                    err = true;
                                }
                                break;
                        ...
                        case MAPPEND:
                            {
                                if ( !append ( line.kbuf, line.ksiz, line.vbuf, line.vsiz ) )
                                {
                                    err = true;
                                }
                                break;
            ...
            class StreamMetaTrigger : public MetaTrigger
            {
                public:
                    ...
                    void trigger ( Kind kind, const char *message )
                    {
                        ...
                        switch ( kind )
                        {
                            case MetaTrigger::OPEN:
                                kstr = "OPEN";
                                break;
                            case MetaTrigger::CLOSE:
                                kstr = "CLOSE";
                                break;
                            case MetaTrigger::CLEAR:
                                kstr = "CLEAR";
                                break;
                            case MetaTrigger::ITERATE:
                                kstr = "ITERATE";
                                break;
                            case MetaTrigger::SYNCHRONIZE:
                                kstr = "SYNCHRONIZE";
                                break;
                            case MetaTrigger::OCCUPY:
                                kstr = "OCCUPY";
                                break;
                            case MetaTrigger::BEGINTRAN:
                                kstr = "BEGINTRAN";
                                break;
                            case MetaTrigger::COMMITTRAN:
                                kstr = "COMMITTRAN";
                                break;
                            case MetaTrigger::ABORTTRAN:
                                kstr = "ABORTTRAN";
                                break;
                            case MetaTrigger::MISC:
                                kstr = "MISC";
                                break;
                        }
                        if ( !prefix_.empty() )
