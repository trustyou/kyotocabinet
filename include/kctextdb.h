    ...
    class TextDB : public BasicDB
    {
        ...
        public:
            ...
            bool accept ( const char *kbuf, size_t ksiz, Visitor *visitor, bool writable = true )
            {
                ...
                bool err = false;
                if ( !accept_impl ( kbuf, ksiz, visitor ) )
                {
                    err = true;
                }
                return !err;
                               ...
                               bool writable = true )
            {
                ...
                while ( kit != kitend )
                {
                    if ( !accept_impl ( kit->data(), kit->size(), visitor ) )
                    {
                        err = true;
                    }
                    ++kit;
