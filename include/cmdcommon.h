...
class DotChecker : public kc::BasicDB::ProgressChecker
{
    ...
    private:
        ...
        {
            if ( std::strcmp ( message, "processing" ) || freq_ == 0 )
            {
                return true;
            }
            if ( freq_ < 0 )
    ...
    class LoggerImpl : public kc::BasicDB::Logger
    {
        public:
                       ...
                       const char *message )
            {
                ...
                switch ( kind )
                {
                    case kc::BasicDB::Logger::DEBUG:
                        kstr = "DEBUG";
                        break;
                    case kc::BasicDB::Logger::INFO:
                        kstr = "INFO";
                        break;
                    case kc::BasicDB::Logger::WARN:
                        kstr = "WARN";
                        break;
                    case kc::BasicDB::Logger::ERROR:
                        kstr = "ERROR";
                        break;
                }
                *strm_ << prefix_ << ": [" << kstr << "]: " <<
