    ...
    class DirDB : public BasicDB
    {
        ...
        public:
            ...
            bool accept ( const char *kbuf, size_t ksiz, Visitor *visitor, bool writable = true )
            {
                ...
                if ( !accept_impl ( kbuf, ksiz, visitor, name ) )
                {
                    err = true;
                }
                rlock_.unlock ( lidx );
        ...
        private:
            ...
            bool load_magic()
            {
                ...
                if ( std::strlen ( rp ) < sizeof ( KCDDBMAGICEOF ) - 1 ||
                        std::memcmp ( rp, KCDDBMAGICEOF, sizeof ( KCDDBMAGICEOF ) - 1 ) )
                {
                    return false;
                }
                flags_ = 0;
            ...
            bool accept_impl ( const char *kbuf, size_t ksiz, Visitor *visitor, const char *name )
            {
                ...
                {
                    if ( !accept_visit_empty ( kbuf, ksiz, visitor, rpath, name ) )
                    {
                        err = true;
                    }
                }
                                     ...
                                     const char *name )
            {
                ...
                if ( rbuf == Visitor::REMOVE )
                {
                    ...
                    if ( rbuf != Visitor::NOP )
                    {
                        ...
                        size_t wsiz;
                        if ( !write_record ( rpath, name, kbuf, ksiz, rbuf, rsiz, &wsiz ) )
                        {
                            err = true;
                        }
